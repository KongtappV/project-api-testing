...
class ApiTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # create test citizen
        self.create_registration("1010278345143", "Ryn", "Akaldia", "28/01/2000", "student", "0951153666", "False",
                                 "South Continent jirhadt", "[Astra]")

    def create_registration(self, citizen_id, name, surname, birth_date, phone_num, is_risk, occupation, address,
                            vaccine_taken):
        """
    ...
    def test_post_registration(self):
        ...
        response = self.create_registration("1010278345145", "Tetris", "Spinner", "09/01/2000", "0850592059", "False",
                                            "Gamer", "Wine Cellar", "[]")
    ...
    def test_registration_empty_id(self):
        ...
        response = self.create_registration("", "Dyluze", "Akaldia", "13/09/1997", "0881113333", "False", "Warrior",
    ...
    def test_registration_id_string(self):
        ...
        response = self.create_registration("string", "str", "sentence", "04/04/2004", "0882223333", "False", "student",
                                            "ionia", "[]")
        self.assertEqual("registration failed: invalid citizen ID", response.json()["feedback"])

    def test_registration_empty_first_name(self):
        """ try register a user data with empty first name """
        response = self.create_registration("1109864231798", "", "Akaldia", "12/09/1997", "0882223333", "False",
                                            "Warrior",
                                            "South Continent jirhadt", "[]")
        self.assertEqual("registration failed: missing some attribute", response.json()["feedback"])
    ...
    def test_registration_empty_last_name(self):
        ...
        response = self.create_registration("1109864231798", "Dyluze", "", "03/09/1997", "0882223333", "False",
                                            "Warrior",
                                            "South Continent jirhadt", "[]")
        self.assertEqual("registration failed: missing some attribute", response.json()["feedback"])
    ...
    def test_registration_name_array(self):
        ...
        response = self.create_registration("1110278345543", ["str", "ings"], ["Hello"], "04/04/2004", "0882223333",
                                            "False", "student",
                                            "demacia", "[]")
    ...
    def test_registration_invalid_date(self):
        ...
        response = self.create_registration("1110278345144", "master", "yi", "60/01/2000", "0882223333", "False",
                                            "wuju master",
                                            "ionia", "[]")
    ...
    def test_registration_future_date(self):
        ...
        response = self.create_registration("1106587451355", "Neotica", "Balm", "04/04/2044", "0882223333", "False",
                                            "student",
    ...
    def test_registration_1000_years_ago(self):
        ...
        response = self.create_registration("1000000000002", "Old", "Boi", "04/04/1000", "0882223333", "False",
                                            "corpse",
                                            "Graveyard", "[]")
    ...
    def test_registration_empty_address(self):
        ...
        response = self.create_registration("1109864231798", "Dyluze", "Akaldia", "02/09/1997", "0882223333", "False",
                                            "Warrior", "", "[]")
        self.assertEqual("registration failed: missing some attribute", response.json()["feedback"])

    def test_registration_address_array(self):
        """ try register a user data with multiple address as array """
        response = self.create_registration("1109861834798", "Die", "Addrie", "02/02/1997", "0882323333", "False",
                                            "Student", ["99/302", "99/303"], "[]")
        self.assertEqual("registration success!", response.json()["feedback"])
